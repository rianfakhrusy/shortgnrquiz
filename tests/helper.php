...
/**
 * Test helpers for the shortgnrquiz question type.
 *
 * @package    qtype_shortgnrquiz
...
/**
 * Test helper class for the shortgnrquiz question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_shortgnrquiz_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a shortgnrquiz question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_shortgnrquiz_question
     */
    public function make_shortgnrquiz_question_frogtoad() {
        question_bank::load_question_definition_classes('shortgnrquiz');
        $sa = new qtype_shortgnrquiz_question();
        ...
        $sa->qtype = question_bank::get_qtype('shortgnrquiz');

        return $sa;
    }

    /**
     * Gets the question data for a shortgnrquiz question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_shortgnrquiz_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'shortgnrquiz';
    ...
    /**
     * Gets the question form data for a shortgnrquiz question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_shortgnrquiz_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a shortgnrquiz question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_shortgnrquiz_question
     */
    public function make_shortgnrquiz_question_frogonly() {
        question_bank::load_question_definition_classes('shortgnrquiz');
        $sa = new qtype_shortgnrquiz_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a shortgnrquiz questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_shortgnrquiz_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_shortgnrquiz_question
     */
    public function make_shortgnrquiz_question_escapedwildcards() {
        question_bank::load_question_definition_classes('shortgnrquiz');
        $sa = new qtype_shortgnrquiz_question();
        test_question_maker::initialise_a_question($sa);
