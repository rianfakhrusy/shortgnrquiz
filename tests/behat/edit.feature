...
Feature: Test editing a Short answer question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | shortgnrquiz | shortgnrquiz-001 for editing | frogtoad |
  ...
  Scenario: Edit a Short answer question
    When I click on "Edit" "link" in the "shortgnrquiz-001 for editing" "table_row"
    And I set the following fields to these values:
      | Question name | |
    And I press "id_submitbutton"
    Then I should see "You must supply a value here."
    When I set the following fields to these values:
      | Question name | Edited shortgnrquiz-001 name |
    And I press "id_submitbutton"
    Then I should see "Edited shortgnrquiz-001 name"
    When I click on "Edit" "link" in the "Edited shortgnrquiz-001 name" "table_row"
    And I set the following fields to these values:
      | id_answer_1          | newt                       |
      | id_fraction_1        | 70%                        |
    ...
    And I press "id_submitbutton"
    Then I should see "Edited shortgnrquiz-001 name"
    When I click on "Preview" "link" in the "Edited shortgnrquiz-001 name" "table_row"
